...
(function ($) {
    ...
    window.initCustomerGsap = function() {
	...
	// ScrollSmoother applies transform to #smooth-content and breaks CSS position:sticky
	// (stacked service cards). Set true to re-enable inertia scroll site-wide.
	var BB_ENABLE_SCROLL_SMOOTHER = false;

	if (BB_ENABLE_SCROLL_SMOOTHER && $('#smooth-wrapper').length && $('#smooth-content').length) {
    ...
    }; // end window.initCustomerGsap
    window.initCustomerGsap();
})(jQuery);
